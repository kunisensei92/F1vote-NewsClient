...
/**
 * Created by markopolo on 16/06/2017.
 */

public class F1voteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_f1vote, container, false);

        refreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.srl_f1vote);
        recyclerView = (RecyclerView) view.findViewById(R.id.rv_f1vote);
