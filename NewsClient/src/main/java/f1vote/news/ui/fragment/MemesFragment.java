...
public class MemesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.srl_memes);
        listView = (RecyclerView) view.findViewById(R.id.rv_memes);
    ...
    private void getData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    list = new NewsItemBiz().getNewsItems(URLUtil.NEWS_TYPE_MEMES);
